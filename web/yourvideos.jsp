...
%>
                <div class="row">
<%
        ResultSet rs3 = st1.executeQuery("select * from video where user_code='"+code+"'");
        while(rs3.next()){
            vidcode = rs3.getString("code");
            dt=rs3.getString("dt");
%>
...
%>
                    ...
                    <div class="row">
                        <a href="channel.jsp?id=<%=code%>" class="ml-3 mr-2"><img src="userimages/<%=code%>.jpg" style="height:30px;width:30px" class="rounded-circle"></a>
<%
    ResultSet rs4 = st2.executeQuery("select * from users where code='"+code+"'");
    while(rs4.next()){
%>
                            <a href="channel.jsp?id=<%=code%>"><p class="text-dark"><u><%=rs4.getString("name")%></u></p></a>
<%
    }
%>
                        </div>
...
%>
                <div class="row" style="height:80vh">
                    <div class='mx-auto my-auto'>
                        <div class='row'><span class="fa fa-folder-open-o mx-auto" style='font-size:100px'></span></div>
                        <div class='row'><h6 class='mx-auto'>Sign In to Upload your videos</h6></div>
                        <div class='row'><p class='mx-auto'>Uploads aren't viewable when signed out.</p></div>
