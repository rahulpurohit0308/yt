...
%>
                <div class="row">
<%
    ResultSet rs2 = st.executeQuery("select * from likes where usercode='"+code+"' and status='1' order by status desc");
    while(rs2.next()){
...
%>
        <div class="row" style="height:80vh">
            <div class='mx-auto my-auto'>
                <div class='row'><span class="fa fa-sign-in mx-auto" style='font-size:100px'></span></div>
                <div class='row'><h6 class='mx-auto'>Keep track of which videos you like</h6></div>
                <div class='row'><p class='mx-auto'>Liked videos aren't viewable when signed out.</p></div>
